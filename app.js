...
function startGame(gameName) {
    ...
    switch (gameName) {
        ...
        case 'whackamole':
            ...
            break;
        case 'sudoku':
            currentGame = new SudokuGame(gameArea);
            break;
        case 'checkers':
            currentGame = new CheckersGame(gameArea);
            break;
        case 'hangman':
            currentGame = new HangmanGame(gameArea);
            break;
        case 'colormatch':
            currentGame = new ColorMatchGame(gameArea);
            break;
        case 'mazerunner':
            currentGame = new MazeRunnerGame(gameArea);
            break;
        case 'reactiontime':
            currentGame = new ReactionTimeGame(gameArea);
            break;
        case 'quizmaster':
            currentGame = new QuizMasterGame(gameArea);
            break;
        case 'bubblepop':
            currentGame = new BubblePopGame(gameArea);
            break;
        case 'numberrush':
            currentGame = new NumberRushGame(gameArea);
            break;
        case 'typingspeed':
            currentGame = new TypingSpeedGame(gameArea);
            break;
    }
}
